...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $posts->each(fn ($post) => Post::create(['title'=>$post->title, 'slug'=>$post->slug, 'content'=>$post->content, 'excerpt'=>$post->excerpt, 'is_published'=>$post->is_published, 'min_to_read'=>$post->min_to_read]));
        // Post::create([
        //     'title' => 'Post 1',
        //     'slug' => 'post-1',
        //     'content' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam sit amet nunc nec nibh efficitur interdum.',
